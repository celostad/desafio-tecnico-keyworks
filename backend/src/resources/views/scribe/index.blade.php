...
<body data-languages="[&quot;javascript&quot;,&quot;bash&quot;]">
    ...
    <div class="tocify-wrapper">
        ...
        <ul class="toc-footer" id="last-updated">
            <li>Last updated: Nov 06 2022</li>
        </ul>
    </div>
    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <pre><code class="language-yaml">http://localhost:3007</code></pre>
...
fetch(url, {
    ...
    headers,
                ...
                <div class="bash-example">
                    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:3007/task/3" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
                </div>
...
fetch(url, {
    ...
    \"team\": \"[]\"
            ...
            <span id="example-requests-POSTtask-order--id-">
                ...
                <div class="javascript-example">
                    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:3007/task-order/14"
);
